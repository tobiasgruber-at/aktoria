...
class CustomUserDetailServiceUnitTest {
    ...
    void createUserIsOK() throws ServiceException, ValidationException {
        ...
        assertEquals(new UserRegistrationDto("Anna", "anna.stunt@mail.com", "jdasdjiajsidjasidjasdjksadjkasjdkajdkasjdkasjdkajsdksajdkasjdkjasdjasdjasdakl"), userService.createUser(new UserRegistrationDto("Anna", "anna.stunt@mail.com", "jdasdjiajsidjasidjasdjksadjkasjdkajdkasjdkasjdkajsdksajdkasjdkjasdjasdjasdakl")));
    }

    @Test
    @DisplayName("assert that ValidationException is thrown")
    void createUserThrowsException() throws ValidationException {
        //whitespaces Tests
        assertThrows(ServiceException.class, () -> {
            userService.createUser(new UserRegistrationDto("", "anna.stunt@mail.com", "jdasdjiajsid"));
        });
        assertThrows(ServiceException.class, () -> {
            userService.createUser(new UserRegistrationDto("  ", "anna.stunt@mail.com", "jalloo"));
        });
        assertThrows(ServiceException.class, () -> {
            userService.createUser(new UserRegistrationDto("hallo", "", "jdasdjiajsidjo"));
        });
        assertThrows(ServiceException.class, () -> {
            userService.createUser(new UserRegistrationDto("halloeeqe", "  ", "jdasdjiajsidjoopopopop"));
        });
        assertThrows(ServiceException.class, () -> {
            userService.createUser(new UserRegistrationDto("test3", "jan.stunt@mail.com", ""));
        });
        assertThrows(ServiceException.class, () -> {
            userService.createUser(new UserRegistrationDto("test1", "janis.stunt@mail.com", "   "));
        });

        //TODO: validation tests
        //Name Tests
        assertThrows(ServiceException.class, () -> {
            userService.createUser(new UserRegistrationDto("", "anna.stunt@mail.com", "jdasdjiajsidjasidjasdjksadjkasjdkajdkasjdkasjdkajsdksajdkasjdkjasdjasdjasdakl"));
        });
        assertThrows(ServiceException.class, () -> {
            userService.createUser(new UserRegistrationDto("", "anna.stunt@mail.com", "jdasdjiajsidjasidjasdjksadjkasjdkajdkasjdkasjdkajsdksajdkasjdkjasdjasdjasdakl"));
        });
